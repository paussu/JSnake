...
{
    SnakeDirection direction = mSnake.front().direction;
    ...
    SnakeDirection lastDirection = SnakeDirection::LEFT;
    bool lastCurve = false;
    bool lastInvertedCurve = false;
...
bool Snake::IsInside(const ALLEGRO_VERTEX &position) const
{
